...
func BuildHTTP(ctx context.Context, initial config.Initial, observer invoker.Observer) (*http.HTTP, func(), error) {
	...
	sdkAppSet := sdk2.AppSet{
		Authentication: authenticationService,
		Handlers:       commonHandlers,
	}
	config2, cleanup21, err := sdk2.Cfg(configurator)
	if err != nil {
		cleanup20()
		cleanup19()
		cleanup18()
	...
	dispatcher, cleanup22, err := sdk2.ProviderDispatcher(ctx, awareSet, sdkAppSet, config2)
	if err != nil {
		cleanup21()
		cleanup20()
		cleanup19()
	...
	httpHTTP, cleanup24, err := http.Provider(ctx, awareSet, dispatcher, httpConfig)
	if err != nil {
		cleanup23()
		cleanup22()
		cleanup21()
...
func BuildHTTPTest(ctx context.Context, initial config.Initial, observer invoker.Observer) (*http.HTTP, func(), error) {
	...
	config2, cleanup20, err := sdk2.CfgTest()
	if err != nil {
		cleanup19()
		cleanup18()
		cleanup17()
	...
	dispatcher, cleanup21, err := sdk2.ProviderDispatcher(ctx, awareSet, sdkAppSet, config2)
	if err != nil {
		cleanup20()
		cleanup19()
		cleanup18()
	...
	httpHTTP, cleanup23, err := http.Provider(ctx, awareSet, dispatcher, httpConfig)
	if err != nil {
		cleanup22()
		cleanup21()
		cleanup20()
